public class Order {
    ...
    public Order(String name1, String lastName1, String s, String s1, String s2, int i, String s3) {
    }

    public Order(String name1, String lastName1, String address, String metroStation, String phone, int rentTime, String deliveryDate, String[] strings) {
    }
